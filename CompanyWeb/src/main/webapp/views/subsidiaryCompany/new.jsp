...
<div class="body1">
	...
	<form action="addSubsidiaryCompany" method="post">
			Name Company <input type="text" name="name">
		Annual Earnings <input type="text" name="annualEarnings">
		<c:forEach var="subsidiaryCompany" items="${subsidiaryCompany}">
			<input type="radio" name="subsidiaryCompany" value="${subsidiaryCompany}">
		</c:forEach>
		<button type="submit">Add Subsidiary Company</button>
	</form>
</div>
	<div class="atHome">
