...
<div class="body1">
	...
	<form action="addMainCompany" method="post">
		...
		<c:forEach var="mainCompany" items="${mainCompanys}">
			<input type="radio" name="mainCompany" value="${mainCompany.id}">
		</c:forEach>
		<button type="submit">Add Main Company</button>
	</form>
...
<img src='<c:url value="http://st2.depositphotos.com/4103319/5941/i/170/depositphotos_59413671-Left-Arrow-square-icon-on-white-background.jpg"></c:url>' /></a>
	<a href="viewAllMainComp" >Повернутись до перегляду</a>
	</div>
	<div class="about">
